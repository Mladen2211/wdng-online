...
const translations = {
  en: {
    ...
    builder: {
      ...
      notifyEmailsHint: 'Comma-separated emails that receive each RSVP response.',
      alternativeContactText: 'Alternative Contact Text',
      alternativeContactTextHint: 'e.g. Or let us know by phone/WhatsApp: +49 123 456789',
  ...
  de: {
    ...
    builder: {
      ...
      notifyEmails: 'Benachrichtigungs-E-Mails',
      notifyEmailsHint: 'Kommagetrennte E-Mails, die jede RSVP-Antwort erhalten.',
      alternativeContactText: 'Alternativer Kontakttext',
      alternativeContactTextHint: 'z.B. Oder meldet euch per Telefon/WhatsApp: +49 123 456789',
  ...
  hr: {
    ...
    builder: {
      ...
      notifyEmails: 'E-mail Za Obavijesti',
      notifyEmailsHint: 'E-mail adrese odvojene zarezom koje primaju svaki RSVP odgovor.',
      alternativeContactText: 'Alternativni kontakt tekst',
      alternativeContactTextHint: 'npr. Ili nam se javite telefonom/WhatsAppom: +385 91 123 4567',
